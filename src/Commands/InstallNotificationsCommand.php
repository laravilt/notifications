...
namespace Laravilt\Notifications\Commands;

use Illuminate\Console\Command;
use Illuminate\Support\Facades\Artisan;

class InstallNotificationsCommand extends Command
{
    /**
     ...
     */
    protected $description = 'Install Notifications plugin';
...
protected function publishAssets(): void
    ...
    }protected function buildAssets(): void
    {
        ...
        $process = Process::path(base_path('packages/laravilt/notifications'))
